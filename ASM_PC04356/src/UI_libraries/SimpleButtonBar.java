package UI_libraries;

import com.poly.gui.CuaSoChinh;
import com.poly.gui.CuaSoDangNhap;
...
//        });
        cmdClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                int kq = JOptionPane.showConfirmDialog(csc, "Bạn có chắc chắn muốn thoát không?", "Thoát", JOptionPane.YES_NO_OPTION);
...
//        });
    ...
    private void initComponents() {
        ...
        cmdClose = new UI_libraries.Buttont();
        cmdMinimize = new UI_libraries.Buttont();
    ...
    private UI_libraries.Buttont cmdClose;
    private UI_libraries.Buttont cmdMinimize;
