...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/poly/pictures/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/poly/pictures/eye_hide.png")).getImage();
